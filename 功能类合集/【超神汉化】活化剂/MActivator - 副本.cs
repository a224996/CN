...
namespace MasterActivator
{
    internal class MActivator
    {
        ...
        private void createMenu()
        {
            ...
            Config.AddSubMenu(new Menu("净化", "purifiers"));
            ...
            Config.AddSubMenu(new Menu("净化", "purify"));
            ...
            if (Utility.Map.GetMap()._MapType.Equals(Utility.Map.MapType.TwistedTreeline))
            {
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("TT_Spiderboss", "大蜘蛛")).SetValue(true);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("TT_NWraith", "幽灵")).SetValue(false);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("TT_NGolem", "石头人")).SetValue(true);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("TT_NWolf", "三狼")).SetValue(true);
            }
            else
            {
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("AncientGolem", "蓝")).SetValue(true);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("LizardElder", "红")).SetValue(true);
                ...
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("GreatWraith", "大幽灵")).SetValue(false);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("Wraith", "幽灵")).SetValue(false);
                Config.SubMenu("smiteCfg").AddItem(new MenuItem("Golem", "石头人")).SetValue(false);
            ...
            Config.AddSubMenu(new Menu("药剂", "regenerators"));
            ...
            Config.AddItem(new MenuItem("predict", "预判")).SetValue(true);
