    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                /* Drawings submenu */
                var drawings = new Menu("鑼冨洿", "drawings");
                drawings.AddItem(
                    new MenuItem("AACircle", "AA鑼冨洿").SetShared()
                        .SetValue(new Circle(true, Color.FromArgb(255, 255, 0, 255))));
                drawings.AddItem(
                    new MenuItem("AACircle2", "鏁屼汉AA鑼冨洿").SetShared()
                        .SetValue(new Circle(false, Color.FromArgb(255, 255, 0, 255))));
                drawings.AddItem(
                    new MenuItem("HoldZone", "鎺у埗鑼冨洿").SetShared()
                        .SetValue(new Circle(false, Color.FromArgb(255, 255, 0, 255))));
                ...
                /*Load the menu*/
                _config.AddItem(
                    new MenuItem("LastHit", "琛ュ叺").SetShared()
                        .SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press, false)));

                _config.AddItem(
                    new MenuItem("Farm", "娣峰悎").SetShared()
                        .SetValue(new KeyBind("C".ToCharArray()[0], KeyBindType.Press, false)));

                _config.AddItem(
                    new MenuItem("LaneClear", "娓呭叺").SetShared()
                        .SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press, false)));

                _config.AddItem(
                    new MenuItem("Orbwalk", "杩炴嫑").SetShared().SetValue(new KeyBind(32, KeyBindType.Press, false)));
