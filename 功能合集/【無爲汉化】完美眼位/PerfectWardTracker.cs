...
namespace PerfectWard
{
    internal class PerfectWardTracker
    {
        ...
        public PerfectWardTracker()
        {
            ...
            //Create the menu
            Config = new LeagueSharp.Common.Menu("【無爲汉化】完美眼位", "PerfectWard", true);

            Config.AddSubMenu(new LeagueSharp.Common.Menu("显示:", "Drawing"));
            Config.SubMenu("Drawing").AddItem(new LeagueSharp.Common.MenuItem("drawplaces", "显示插眼位置").SetValue(new Circle(true, System.Drawing.Color.FromArgb(100, 255, 0, 255))));
            Config.SubMenu("Drawing").AddItem(new LeagueSharp.Common.MenuItem("drawDistance", "不显示 如果距离 >")).SetValue(new Slider(2000, 10000, 1));
            Config.SubMenu("Drawing").AddItem(new LeagueSharp.Common.MenuItem("placekey", "插眼 热键").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Drawing").AddItem(new LeagueSharp.Common.MenuItem("placekeypink", "插真眼 热键").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
