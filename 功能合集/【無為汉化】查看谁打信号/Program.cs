...
namespace UniversalPings
{
    internal class Program
    {
        ...
        {
            _menu = new Menu("【無為汉化】查看谁打信号", "UniversalPings", true);
            _menu.AddItem(new MenuItem("print", "显示").SetValue(new StringList(new[] { "冠军", "英雄", "两者" })));
            _menu.AddItem(new MenuItem("block", "[块的设置]"));
