...
namespace EnemyVision
{
    internal class Vision
    {
        ...
        public Vision()
        {
            _menu = new Menu("【無為汉化】敌人视野", "EnemyVision",true);
            ...
            _menu.AddItem(new MenuItem("VongTron", "只有圈").SetValue(false));
            _menu.AddItem(new MenuItem("NguoiChoiTest", "测试自己的").SetValue(false));
            _menu.AddItem(new MenuItem("Active", "启用").SetValue(true));
            _menu.AddToMainMenu();
