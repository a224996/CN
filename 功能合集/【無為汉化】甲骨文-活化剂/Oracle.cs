...
namespace Oracle
{
    ...
    internal static class Oracle
    {
        ...
        private static void OnGameLoad(EventArgs args)
        {
            ...
            Origin = new Menu("【無為汉化】甲骨文-活化剂", "oracle", true);
            ...
            var cskills = new Menu("净化专用", "cskills");
            foreach (var i in ObjectManager.Get<Obj_AI_Hero>().Where(hero => hero.Team != Me.Team))
            {
            ...
            var cleanseMenu = new Menu("净化效果", "cdebufs");
            ...
            debugMenu.AddItem(new MenuItem("dbool", "启用控制台调试")).SetValue(false);
            debugMenu.AddItem(new MenuItem("catchobject", "日志对象名称"))
