    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                /* Drawings submenu */
                var drawings = new Menu("·¶Î§", "drawings");
                drawings.AddItem(
                    new MenuItem("AACircle", "Ó¢ÐÛAA·¶Î§").SetShared()
                        .SetValue(new Circle(true, Color.FromArgb(255, 255, 0, 255))));
                drawings.AddItem(
                    new MenuItem("AACircle2", "µÐÈËAA·¶Î§").SetShared()
                        .SetValue(new Circle(false, Color.FromArgb(255, 255, 0, 255))));
                drawings.AddItem(
                    new MenuItem("HoldZone", "¿ØÖÆ·¶Î§").SetShared()
                        .SetValue(new Circle(false, Color.FromArgb(255, 255, 0, 255))));
                ...
                misc.AddItem(
                    new MenuItem("HoldPosRadius", "±£³Ö°ë¾¶Î»ÖÃ").SetShared().SetValue(new Slider(0, 0, 250)));
                ...
                /* Delay sliders */
                _config.AddItem(
                    new MenuItem("ExtraWindup", "ÖÕ½áÊ±¼ä").SetShared().SetValue(new Slider(80, 0, 200)));
                _config.AddItem(new MenuItem("FarmDelay", "²¹±øÑÓ³Ù").SetShared().SetValue(new Slider(0, 0, 200)));
                _config.AddItem(
                ...
                /*Load the menu*/
                _config.AddItem(
                    new MenuItem("LastHit", "²¹±ø").SetShared().SetValue(new KeyBind('X', KeyBindType.Press)));

                _config.AddItem(new MenuItem("Farm", "»ìºÏ").SetShared().SetValue(new KeyBind('T', KeyBindType.Press)));

                _config.AddItem(
                    new MenuItem("LaneClear", "Çå±ø").SetShared().SetValue(new KeyBind('V', KeyBindType.Press)));

                _config.AddItem(
                    new MenuItem("Orbwalk", "Á¬ÕÐ").SetShared().SetValue(new KeyBind(32, KeyBindType.Press)));
