...
namespace ezEvade
{
    ...
    internal class Evade
    {
        ...
        private void Game_OnGameLoad(EventArgs args)
        {
            ...
            keyMenu.AddItem(new MenuItem("DodgeDangerousKeyEnabled", "只躲避危险技能(锁定)").SetValue(false));
            ...
            bufferMenu.AddItem(new MenuItem("ExtraDelay", "躲避延迟缓冲器").SetValue(new Slider(60, 0, 150)));
