...
namespace KaiHelper.Misc
{
    internal class Vision
    {
        ...
        public Vision(Menu menu)
        {
            ...
            _menu.AddItem(new MenuItem("VongTron", "只显示圆圈").SetValue(false));
            _menu.AddItem(new MenuItem("NguoiChoiTest", "测试自己的范围").SetValue(false));
            _menu.AddItem(new MenuItem("Active", "开启").SetValue(false));
