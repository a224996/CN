...
namespace Support.Plugins
{
    public class Karma : PluginBase
    {
        ...
        {
            config.AddSlider("Misc.Q.Count", "R/Q 鏁屼汉鍦ㄥ皠绋嬪唴", 2, 0, 4);
            config.AddSlider("Misc.W.Hp", "R/W 琛€閲忋劎", 40, 1, 100);
            config.AddSlider("Misc.E.Count", "R/E 闃熷弸鐨勮寖鍥淬劎", 3, 0, 4);
        }
        ...
        {
            config.AddBool("Gapcloser.W", "浣跨敤 W 闃茬獊杩涖劎", true);
        }
    }
}