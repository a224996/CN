...
namespace Support.Plugins
{
    public class Janna : PluginBase
    {
        ...
        {
            config.AddBool("Misc.E.Tower", "在塔下使用ㄧE", true);

            // build aa menu
            var aa = config.AddSubMenu(new Menu("使用 E 再攻击ㄧ", "Misc.E.AA.Menu"));
            ...
            // build spell menu
            var dmg = config.AddSubMenu(new Menu("使用 E 的法术ㄧ", "Misc.E.Spell.Menu"));
            foreach (
                var spell in
        ...
        public override void InterruptMenu(Menu config)
        {
            ...
            config.AddBool("Gapcloser.W", "使用 W 防突进ㄧ", true);
