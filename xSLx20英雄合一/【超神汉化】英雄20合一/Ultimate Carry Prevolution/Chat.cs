		...
		public static void WellCome()
		{
			...
			if (IsChampionSupported())
			{
				Game.PrintChat(
					...
					HtmlColor.Cyan, HtmlColor.Gold);
			Game.PrintChat("<font color=\"#00BFFF\">====== 鎴愬姛杞藉叆:銆愯秴绁炴眽鍖栥€憒xSLx鑻遍泟20鍚堜竴|=======</font>");
			Game.PrintChat("<font color=\"#00BFFF\">====== 鐗堟湰: v 1.0.1.0====== </font>");
			Game.PrintChat("<font color=\"#00BFFF\">|鍓戦瓟|鐙愮嫺|闃垮崱涓絴鐗涘ご|鏈ㄦ湪|鍑ゅ嚢|瀵掑啺|鐨囧笣|鏈哄櫒|濂宠|椋炴満|EZ|鍓戝К|绾冲皵|鍒€濡箌閲戝厠涓潀鏃ュコ|鍗㈣タ瀹墊鐙瓙鐙梶鐟炲吂|杈涘痉鎷墊钖囨仼|</font>");
