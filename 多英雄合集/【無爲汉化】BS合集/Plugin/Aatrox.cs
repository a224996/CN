        ...
        public Aatrox()
        {
            ...
            var ChampMenu = new Menu("英雄", PlayerName + "_Plugin");
            {
                var ComboMenu = new Menu("连招", "Combo");
                {
                    ...
                    AddItem(ComboMenu, "WHpU", "-> 切换到治疗模式 血量", 50);
                    AddItem(ComboMenu, "E", "使用 E");
                    AddItem(ComboMenu, "R", "使用 R");
                    AddItem(ComboMenu, "RHpU", "-> 如果敌人血量", 60);
                ...
                var HarassMenu = new Menu("骚扰", "Harass");
                {
                    ...
                    AddItem(HarassMenu, "AutoEHpA", "-> 血量", 50);
                    AddItem(HarassMenu, "Q", "使用 Q");
                    AddItem(HarassMenu, "QHpA", "-> 血量", 20);
                ...
                var ClearMenu = new Menu("清兵/清野", "Clear");
                {
                    ...
                    AddItem(ClearMenu, "WHpU", "-> 切换到治疗模式 血量", 50);
