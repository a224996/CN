        ...
        public Maokai()
        {
            ...
            var ChampMenu = new Menu("英雄", PlayerName + "_Plugin");
            {
                var ComboMenu = new Menu("连招", "Combo");
                {
                    ...
                    AddItem(ComboMenu, "RKill", "-> 如果杀死自动取消");
                    AddItem(ComboMenu, "RMpU", "-> 蓝量", 20);
                ...
                var MiscMenu = new Menu("杂项", "Misc");
                {
                    ...
                    var AntiGapMenu = new Menu("反突进", "AntiGap");
                    {
                        ...
                        AddItem(AntiGapMenu, "QSlow", "-> 慢 如果能击退 (放技能)");
                    ...
                    AddItem(MiscMenu, "WTower", "使用 W 如果敌人在塔下");
