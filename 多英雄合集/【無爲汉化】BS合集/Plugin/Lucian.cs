        ...
        public Lucian()
        {
            ...
            var ChampMenu = new Menu("英雄", PlayerName + "_Plugin");
            {
                var ComboMenu = new Menu("连招", "Combo");
                {
                    ...
                    AddItem(ComboMenu, "PSave", "-> 永远保存", false);
                    AddItem(ComboMenu, "Q", "使用 Q");
                    AddItem(ComboMenu, "QExtend", "-> 延长");
                    AddItem(ComboMenu, "W", "使用 W");
                    AddItem(ComboMenu, "WPred", "-> 预测", false);
                    AddItem(ComboMenu, "E", "使用 E");
                    AddItem(ComboMenu, "EGap", "-> 突进");
                    AddItem(ComboMenu, "EDelay", "-> 停止 Q/W 如果 E 没好", 500, 0, 1000);
                    AddItem(ComboMenu, "EMode", "-> 模式", new[] { "Safe", "Mouse", "Chase" });
                    AddItem(ComboMenu, "EModeKey", "--> 开关", "Z", KeyBindType.Toggle).ValueChanged += ComboEModeChanged;
                    AddItem(ComboMenu, "EModeDraw", "--> 显示文本", false);
                    AddItem(ComboMenu, "R", "使用 R (可击杀)");
                    AddItem(ComboMenu, "RItem", "-> 使用幽梦");
                    ChampMenu.AddSubMenu(ComboMenu);
                }
                var HarassMenu = new Menu("骚扰", "Harass");
                {
                    AddItem(HarassMenu, "AutoQ", "使用 Q 延长", "H", KeyBindType.Toggle);
                    AddItem(HarassMenu, "AutoQMpA", "-> 蓝量", 50);
                    AddItem(HarassMenu, "P", "使用被动");
                    AddItem(HarassMenu, "PSave", "-> 永远保存", false);
                    AddItem(HarassMenu, "Q", "使用 Q");
                    AddItem(HarassMenu, "W", "使用 W");
                    AddItem(HarassMenu, "E", "使用 E");
                    AddItem(HarassMenu, "EHpA", "-> 血量", 20);
                ...
                var ClearMenu = new Menu("清兵/清野", "Clear");
                {
                    ...
                    AddItem(ClearMenu, "EDelay", "-> 停止 Q/W 如果 E 没好", 500, 0, 1000);
