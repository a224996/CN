...
namespace Marksman
{
    internal class Tristana : Champion
    {
        ...
        public override bool ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("UseWCS" + Id, "完成 E 叠 W").SetValue(true));
            config.AddItem(new MenuItem("UseEC" + Id, "使用 E").SetValue(true));

            config.AddSubMenu(new Menu("不使用 E", "DontUseE"));
            {
        ...
        public override bool HarassMenu(Menu config)
        {
            ...
            config.AddItem(
                new MenuItem("UseETH" + Id, "使用 E (切换)").SetValue(
        ...
        {
            config.AddItem(new MenuItem("DrawW" + Id, "W 范围").SetValue(new Circle(true, Color.Beige)));

            var drawE = new Menu("Draw E", "DrawE");
            {
                drawE.AddItem(new MenuItem("DrawE", "E 范围").SetValue(new Circle(true, Color.Beige)));
                drawE.AddItem(
                    new MenuItem("DrawEMarkEnemy", "E 标记的敌人").SetValue(new Circle(true, Color.GreenYellow)));
                drawE.AddItem(new MenuItem("DrawEMarkStatus", "E 标记的状况").SetValue(true));
        ...
        {
            config.AddItem(new MenuItem("UseWM" + Id, "使用 W 击杀").SetValue(true));
