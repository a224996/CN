...
namespace Sharpshooter.Champions
{
    public static class Twitch
    {
        ...
        public static void Load()
        {
            ...
            var drawDamageMenu = new MenuItem("Draw_EDamage", "显示(E)伤害", true).SetValue(true);
            ...
            SharpShooter.Menu.SubMenu("Combo").AddItem(new MenuItem("comboUseEStack", "自动 E 叠层数 >=", true).SetValue(new Slider(6, 1, 6)));
            ...
            SharpShooter.Menu.SubMenu("Harass").AddItem(new MenuItem("harassUseEStack", "自动 E 叠层数 >=", true).SetValue(new Slider(4, 1, 6)));
            ...
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("killsteal", "使用抢人头 (随着 E)", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("stealthrecall", "隐身回城", true).SetValue(new KeyBind('T',KeyBindType.Press)));

            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "真正的 AA 范围", true).SetValue(new Circle(true, Color.LightGreen)));
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingW", "W 范围", true).SetValue(new Circle(true, Color.LightGreen)));
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingE", "E 范围", true).SetValue(new Circle(false, Color.LightGreen)));
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingQTimer", "隐身计时器", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingRTimer", "R 计时器", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingRLine", "R 穿刺线", true).SetValue(true));
