...
namespace Sharpshooter.Champions
{
    public static class _base
    {
        ...
        public static void Load()
        {
            ...
            var drawDamageMenu = new MenuItem("Draw_RDamage", "显示 ( ) 伤害", true).SetValue(true);
            var drawFill = new MenuItem("Draw_Fill", "显示 ( ) 补充伤害", true).SetValue(new Circle(true, Color.FromArgb(90, 255, 169, 4)));
            ...
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "真实 AA 范围", true).SetValue(new Circle(true, Color.FromArgb(183, 0, 0))));
