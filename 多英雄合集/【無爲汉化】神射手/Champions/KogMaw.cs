    ...
    public static class KogMaw
    {
       ...
       // R 2 = 1500
        ...
        public static void Load()
        {
            ...
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("empty1", "空的", true));

            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "真实 AA 范围", true).SetValue(new Circle(true, Color.FromArgb(0, 216, 255))));
