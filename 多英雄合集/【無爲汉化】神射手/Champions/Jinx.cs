...
namespace Sharpshooter.Champions
{
    public static class Jinx
    {
        ...
        public static void Load()
        {
            ...
            var drawDamageMenu = new MenuItem("Draw_RDamage", "显示 (W, R) 伤害", true).SetValue(true);
            var drawFill = new MenuItem("Draw_Fill", "显示 (W, R) 补充伤害", true).SetValue(new Circle(true, Color.FromArgb(90, 255, 169, 4)));
            ...
            SharpShooter.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearQnum", "最少小兵 >=", true).SetValue(new Slider(2, 2, 7)));
            ...
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("AutoE", "对被控住目标使用 E", true).SetValue(true));
