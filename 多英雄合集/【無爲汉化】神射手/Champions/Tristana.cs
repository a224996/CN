...
namespace Sharpshooter.Champions
{
    public static class Tristana
    {
        ...
        public static void Load()
        {
            ...
            var drawDamageMenu = new MenuItem("Draw_RDamage", "显示 (E, R) 伤害", true).SetValue(true);
            var drawFill = new MenuItem("Draw_Fill", "显示 (E, R) 补充伤害", true).SetValue(new Circle(true, Color.FromArgb(90, 255, 169, 4)));

            SharpShooter.Menu.SubMenu("Combo").AddItem(new MenuItem("comboUseQ", "使用 Q", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Combo").AddItem(new MenuItem("comboUseW", "使用 W", true).SetValue(false));
            ...
            SharpShooter.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearUseQ", "使用 Q", true).SetValue(false));
            //SharpShooter.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearMana", "蓝量 % >", true).SetValue(new Slider(50, 0, 100)));
            ...
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("killsteal", "使用抢人头 (随着 R)", true).SetValue(true));

            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "真正的 AA 范围", true).SetValue(new Circle(true, Color.FromArgb(255, 178, 217))));
            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingW", "W 范围", true).SetValue(new Circle(true, Color.FromArgb(255, 178, 217))));
