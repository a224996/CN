...
namespace Sharpshooter.Champions
{
    public static class Kalista
    {
        ...
        public static void Load()
        {
            ...
            SharpShooter.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearQnum", "最少小兵 >=", true).SetValue(new Slider(3, 1, 5)));
            SharpShooter.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearUseE", "使用 E", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearEnum", "最少小兵 >=", true).SetValue(new Slider(2, 1, 5)));
            ...
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("mobsteal", "使用偷野怪 (随着 E)", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("lasthitassist", "使用补兵辅助 (随着 E)", true).SetValue(true));
            SharpShooter.Menu.SubMenu("Misc").AddItem(new MenuItem("soulboundsaver", "使用灵魂绑定器(随着 R)", true).SetValue(true));

            SharpShooter.Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingAA", "真正的 AA 范围", true).SetValue(new Circle(true, Color.FromArgb(0, 230, 255))));
