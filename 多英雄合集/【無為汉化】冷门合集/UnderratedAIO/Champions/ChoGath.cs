...
namespace UnderratedAIO.Champions
{
    class Chogath
    {
        ...
        {
            config = new Menu("【無為汉化】大虫子", "ChoGath", true);
            // Target Selector
            ...
            menuD.AddItem(new MenuItem("drawaa", "显示 AA 范围")).SetValue(new Circle(false, Color.FromArgb(180, 200, 46, 66)));
            menuD.AddItem(new MenuItem("drawqq", "显示 Q 范围")).SetValue(new Circle(false, Color.FromArgb(180, 200, 46, 66)));
            menuD.AddItem(new MenuItem("drawww", "显示 W 范围")).SetValue(new Circle(false, Color.FromArgb(180, 200, 46, 66)));
            menuD.AddItem(new MenuItem("drawee", "显示 E 范围")).SetValue(new Circle(false, Color.FromArgb(180, 200, 46, 66)));
            menuD.AddItem(new MenuItem("drawrrflash", "显示 R+闪现范围")).SetValue(new Circle(true, Color.FromArgb(150, 250, 248, 110)));
            ...
            menuC.AddItem(new MenuItem("qHit", "Q 命中率", true).SetValue(new Slider(3, 1, 4)));
            menuC.AddItem(new MenuItem("useqfaster", "使用快速 Q 预判")).SetValue(false);
            ...
            menuC.AddItem(new MenuItem("UseFlashC", "使用闪现")).SetValue(false);
            ...
            menuH.AddItem(new MenuItem("usewH", "使用 W")).SetValue(true);
            ...
            menuLC.AddItem(new MenuItem("minmana", "保持X%的法力")).SetValue(new Slider(1, 1, 100));
            config.AddSubMenu(menuLC);
            // Jungle Settings
            Menu menuJ = new Menu("清野 ", "Jsettings");
            menuJ.AddItem(new MenuItem("useSmite", "使用惩戒")).SetValue(true);
            menuJ.AddItem(new MenuItem("useRJ", "使用 R")).SetValue(true);
            menuJ.AddItem(new MenuItem("priorizeSmite", "使用惩戒")).SetValue(false);
            menuJ.AddItem(new MenuItem("useFlashJ", "使用闪现偷野")).SetValue(true);
            config.AddSubMenu(menuJ);
            // Misc Settings
            Menu menuM = new Menu("杂项", "Msettings");
            menuM.AddItem(new MenuItem("useQint", "使用 Q 打断技能")).SetValue(true);
            menuM.AddItem(new MenuItem("useQgc", "使用 Q 反突进")).SetValue(false);
            menuM.AddItem(new MenuItem("useWint", "使用 W 打断技能")).SetValue(true);
            menuM.AddItem(new MenuItem("useWgc", "使用 W 反突进")).SetValue(false);
