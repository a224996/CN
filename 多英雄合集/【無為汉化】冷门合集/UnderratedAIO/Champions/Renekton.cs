...
namespace UnderratedAIO.Champions
{
    class Renekton
    {
        ...
        {
            config = new Menu("【無為汉化】鳄鱼", "Renekton", true);
            // Target Selector
            ...
            menuD.AddItem(new MenuItem("drawqq", "显示 Q 范围")).SetValue(new Circle(false, Color.FromArgb(180, 109, 111, 126)));
            ...
            menuD.AddItem(new MenuItem("rDamage", "计算R伤害")).SetValue(true);
            ...
            menuC.AddItem(new MenuItem("user", "使用 R 血量")).SetValue(new Slider(20, 0, 100));
            menuC.AddItem(new MenuItem("userindanger", "使用 R 几个敌人")).SetValue(new Slider(2, 1, 5));
            ...
            menuH.AddItem(new MenuItem("eqweb", "E-Q-E")).SetValue(true);
            config.AddSubMenu(menuH);
            // LaneClear Settings
            Menu menuLC = new Menu("刷兵", "Lcsettings");
            menuLC.AddItem(new MenuItem("useqLC", "使用 Q")).SetValue(true);
            menuLC.AddItem(new MenuItem("minimumMini", "使用 Q 最少兵")).SetValue(new Slider(2, 1, 6));
