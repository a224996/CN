...
namespace UnderratedAIO.Champions
{
    class Mordekaiser
    {
       ...
       {
           config = new Menu("【無為汉化】金属大师", "Mordekaiser", true);
           // Target Selector
           ...
           menuC.AddItem(new MenuItem("ultDef", "不要使用在 净化/屏障 等...")).SetValue(true);
           ...
           menuM.AddItem(new MenuItem("ghostTarget", "幽魂的优先目标")).SetValue(new StringList(new[] { "目标选择", "低血量", "靠近你的" }, 0));
