...
namespace UnderratedAIO.Champions
{
    class Yorick
    {
       ...
       {
           config = new Menu("【無為汉化】掘墓者", "Yorick", true);
           // Target Selector
           ...
           menuD.AddItem(new MenuItem("drawaa", "显示 AA 范围")).SetValue(new Circle(false, Color.FromArgb(180, 116, 99, 45)));
           menuD.AddItem(new MenuItem("drawqq", "显示 Q 范围")).SetValue(new Circle(false, Color.FromArgb(180, 116, 99, 45)));
           menuD.AddItem(new MenuItem("drawww", "显示 W 范围")).SetValue(new Circle(false, Color.FromArgb(180, 116, 99, 45)));
           menuD.AddItem(new MenuItem("drawee", "显示 E 范围")).SetValue(new Circle(false, Color.FromArgb(180, 116, 99, 45)));
           menuD.AddItem(new MenuItem("drawrr", "显示 R 范围")).SetValue(new Circle(false, Color.FromArgb(180, 116, 99, 45)));
           ...
           menuC.AddItem(new MenuItem("atpercenty", "大招给队友 血量<")).SetValue(new Slider(30, 0, 100));
           ...
           menuM.AddItem(new MenuItem("ghostTarget", "幽魂优先的目标")).SetValue(new StringList(new[] { "目标选择", "低血量的", "接近你的" }, 0));
