...
namespace DZAIO.Utility
{
    internal class PotionManager
    {
        ...
        private static void AddMenu(Menu menu)
        {
            ...
            var potMenu = new Menu(cName + " - 药瓶管理", DZAIO.Player.ChampionName+"PotM");
            ...
            potMenu.AddItem(new MenuItem(DZAIO.Player.ChampionName + "minHP", "最小血量 %").SetValue(new Slider(30)));
            potMenu.AddItem(new MenuItem(DZAIO.Player.ChampionName + "minMana", "最小蓝量 %").SetValue(new Slider(35)));
