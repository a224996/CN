...
namespace UltimateCarry
{
	class Zed : Champion 
	{
		...
		private void LoadMenu()
		{
			...
			Program.Menu.SubMenu("TeamFight").AddItem(new MenuItem("followW_TeamFight", "按照W的范围").SetValue(true));
			...
			Program.Menu.SubMenu("Harass").AddItem(new MenuItem("followW_Harass", "按照 W").SetValue(false));
			...
			Program.Menu.SubMenu("Passive").AddItem(new MenuItem("useE_Passive", "自动 E").SetValue((new KeyBind("H".ToCharArray()[0], KeyBindType.Toggle, true))));
