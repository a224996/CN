...
namespace UltimateCarry
{
    class Amumu : Champion
    {
        ...
        public Amumu() //add Q near mouse (range), 
        {
            ...
            comboMenu.AddItem(new MenuItem("comboQ" + ObjectManager.Player.ChampionName, "使用 Q").SetValue(new StringList(new[] { "No", "Always", "If out of range"}, 1)));
            ...
            comboMenu.AddItem(new MenuItem("comboR" + ObjectManager.Player.ChampionName, "自动使用 R").SetValue(new Slider(3, 0, 5)));
            comboMenu.AddItem(new MenuItem("comboWPercent" + ObjectManager.Player.ChampionName, "使用 W 蓝量 %").SetValue(new Slider(10)));

            var farmMenu = _menu.AddSubMenu(new Menu("清兵", "Farming"));
            farmMenu.AddItem(new MenuItem("farmQ" + ObjectManager.Player.ChampionName, "使用 Q").SetValue(new StringList(new[] { "No", "Always", "If out of range"}, 2)));
            ...
            farmMenu.AddItem(new MenuItem("farmWPercent" + ObjectManager.Player.ChampionName, "使用 W 蓝量 %").SetValue(new Slider(20)));

            var drawMenu = _menu.AddSubMenu(new Menu("绘制", "Drawing"));
            drawMenu.AddItem(new MenuItem("drawQ" + ObjectManager.Player.ChampionName, "绘制 Q 范围").SetValue(new Circle(true, System.Drawing.Color.FromArgb(125, 0, 255, 0))));
            drawMenu.AddItem(new MenuItem("drawW" + ObjectManager.Player.ChampionName, "绘制 W 范围").SetValue(new Circle(false, System.Drawing.Color.FromArgb(125, 0, 255, 0))));
            drawMenu.AddItem(new MenuItem("drawE" + ObjectManager.Player.ChampionName, "绘制 E 范围").SetValue(new Circle(false, System.Drawing.Color.FromArgb(125, 0, 255, 0))));
            drawMenu.AddItem(new MenuItem("drawR" + ObjectManager.Player.ChampionName, "绘制 R 范围").SetValue(new Circle(false, System.Drawing.Color.FromArgb(125, 0, 255, 0))));

            var miscMenu = _menu.AddSubMenu(new Menu("杂项", "Misc"));
            miscMenu.AddItem(new MenuItem("aimQ" + ObjectManager.Player.ChampionName, "Q 附近的小兵").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
