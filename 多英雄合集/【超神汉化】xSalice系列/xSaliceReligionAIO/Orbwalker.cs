    ...
    public class xSLxOrbwalker
    {
        ...
        public static void AddToMenu(Menu menu)
        {
            ...
            if(MyHero.ChampionName == "Azir")
                menuMisc.AddItem(new MenuItem("azir_Misc_Farmdelay", "清兵延迟").SetValue(new Slider(0, 0, 300)));
            ...
            menuMisc.AddItem(new MenuItem("orb_Misc_Humanizer", "延迟").SetValue(new Slider(50, 0, 500)));
