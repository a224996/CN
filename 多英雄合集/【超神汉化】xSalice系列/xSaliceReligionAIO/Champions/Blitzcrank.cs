    ...
    class Blitzcrank : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("热键", "Keys"); {
                ...
                key.AddItem(new MenuItem("panic", "逃跑按键(无技能)",true).SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                menu.AddSubMenu(key);
            }
            ...
            {
                qMenu.AddItem(new MenuItem("qRange2", "Q 最小距离",true).SetValue(new Slider(300, 1, 950)));
                qMenu.AddItem(new MenuItem("qRange", "Q 最大距离",true).SetValue(new Slider(900, 1, 950)));
                qMenu.AddItem(new MenuItem("qSlow", "自动 Q 缓慢的",true).SetValue(true));
                qMenu.AddItem(new MenuItem("qImmobile", "自动 Q 不动的",true).SetValue(true));
                qMenu.AddItem(new MenuItem("qDashing", "自动 Q 突进的",true).SetValue(true));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("QE", "使用 E 击飞",true).SetValue(true));
            ...
            var misc = new Menu("杂项", "Misc");
            {
                ...
                misc.AddItem(new MenuItem("resetE", "使用 E 重置普攻",true).SetValue(true));
                misc.AddItem(new MenuItem("autoR", "使用 R 敌人数量",true).SetValue(new Slider(3, 0, 5)));

                misc.AddSubMenu(new Menu("不要使用Q", "intR"));
            ...
            //Drawings menu:
            var drawMenu = new Menu("范围", "Drawings"); {
