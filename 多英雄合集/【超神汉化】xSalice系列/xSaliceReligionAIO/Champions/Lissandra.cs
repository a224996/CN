...
namespace xSaliceReligionAIO.Champions
{
    class Lissandra : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            { 
                key.AddItem(new MenuItem("ComboActive", "连招!", true).SetValue(new KeyBind("32".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("HarassActive", "骚扰!", true).SetValue(new KeyBind("S".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("HarassActiveT", "骚扰 (锁定)!", true).SetValue(new KeyBind("Y".ToCharArray()[0], KeyBindType.Toggle)));
                key.AddItem(new MenuItem("stunMelles", "近距离范围击晕敌人", true).SetValue(new KeyBind("M".ToCharArray()[0], KeyBindType.Toggle)));
                key.AddItem(new MenuItem("stunTowers", "塔下击晕敌人", true).SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Toggle)));
                key.AddItem(new MenuItem("alwaysR", "总是使用 R", true).SetValue(new KeyBind("H".ToCharArray()[0], KeyBindType.Toggle)));
                key.AddItem(new MenuItem("LastHitQQ", "使用 Q 补兵", true).SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("LaneClearActive", "清兵!", true).SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                menu.AddSubMenu(key);
            }
            //Combo menu:
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("qHit", "Q 命中率", true).SetValue(new Slider(3, 1, 4)));
                ...
                combo.AddItem(new MenuItem("rHp", "R 血量 <", true).SetValue(new Slider(20)));
                combo.AddItem(new MenuItem("defR", "R 敌人数量 > ", true).SetValue(new Slider(3, 0, 5)));
            ...
            var harass = new Menu("骚扰", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("qHit2", "Q 命中率", true).SetValue(new Slider(3, 1, 4)));
            ...
            {
                misc.AddItem(new MenuItem("UseInt", "使用 R 打断技能", true).SetValue(true));
                misc.AddItem(new MenuItem("UseGap", "使用 W 防突进", true).SetValue(true));
                misc.AddItem(new MenuItem("smartKS", "使用智能抢人头", true).SetValue(true));
                misc.AddItem(new MenuItem("UseHAM", "总是使用 E", true).SetValue(false));
                misc.AddItem(new MenuItem("UseEGap", "使用 E 接近", true).SetValue(true));
                misc.AddItem(new MenuItem("gapD", "最小距离", true).SetValue(new Slider(600, 300, 1050)));
            ...
            { 
                ...
                drawing.AddItem(new MenuItem("qExtend", "扩展 Q 范围", true).SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
                ...
                drawing.AddItem(new MenuItem("rMode", "显示 R 模式", true).SetValue(true));

                MenuItem drawComboDamageMenu = new MenuItem("Draw_ComboDamage", "显示连招伤害", true).SetValue(true);
                MenuItem drawFill = new MenuItem("Draw_Fill", "显示连招补充伤害", true).SetValue(new Circle(true, Color.FromArgb(90, 255, 169, 4)));
