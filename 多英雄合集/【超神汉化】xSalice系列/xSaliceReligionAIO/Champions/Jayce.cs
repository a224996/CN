    ...
    class Jayce : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("热键", "Keys"); { 
                ...
                key.AddItem(new MenuItem("HarassActiveT", "骚扰 (切换)!", true).SetValue(new KeyBind("Y".ToCharArray()[0], KeyBindType.Toggle)));
                key.AddItem(new MenuItem("shootMouse", "鼠标射击QE", true).SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
                menu.AddSubMenu(key);
            }

            //Combo menu:
            var combo = new Menu("连招", "Combo"); { 
                combo.AddItem(new MenuItem("UseQCombo", "使用炮形 Q", true).SetValue(true));
                combo.AddItem(new MenuItem("qSpeed", "QE 速度 高=更快 低=准确", true).SetValue(new Slider(1600, 400, 2500)));
                combo.AddItem(new MenuItem("UseWCombo", "使用炮形 W", true).SetValue(true));
                combo.AddItem(new MenuItem("UseECombo", "使用炮形 E", true).SetValue(true));
                combo.AddItem(new MenuItem("UseQComboHam", "使用锤形 Q", true).SetValue(true));
                combo.AddItem(new MenuItem("UseWComboHam", "使用锤形 W", true).SetValue(true));
                combo.AddItem(new MenuItem("UseEComboHam", "使用锤形 E", true).SetValue(true));
                combo.AddItem(new MenuItem("UseRCombo", "使用 R 开关", true).SetValue(true));
            ...
            var harass = new Menu("骚扰", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("UseQHarassHam", "使用 Q 锤形", true).SetValue(true));
                harass.AddItem(new MenuItem("UseWHarassHam", "使用 W 锤形", true).SetValue(true));
                harass.AddItem(new MenuItem("UseEHarassHam", "使用 E 锤形", true).SetValue(true));
                harass.AddItem(new MenuItem("UseRHarass", "使用 R 开关", true).SetValue(true));
                harass.AddItem(new MenuItem("manaH", "蓝量 > %", true).SetValue(new Slider(40)));
            ...
            var misc = new Menu("杂项", "Misc"); { 
                ...
                misc.AddItem(new MenuItem("gatePlace", "门的距离", true).SetValue(new Slider(300, 50, 600)));
                misc.AddItem(new MenuItem("UseQAlways", "使用 Q 当E正在CD", true).SetValue(true));
                misc.AddItem(new MenuItem("autoE", "连招用E推开 血量 < %", true).SetValue(new Slider(20)));
            ...
            var drawMenu = new Menu("绘制", "Drawings"); {
                ...
                drawMenu.AddItem(new MenuItem("Draw_Q2", "绘制 Q 锤形", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("Draw_E2", "绘制 E 锤形", true).SetValue(true));
                drawMenu.AddItem(new MenuItem("drawcds", "绘制冷却时间", true).SetValue(true));
