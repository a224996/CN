...
namespace xSaliceReligionAIO
{
    class Champion
    {
        ...
        public void GameOnLoad()
        {
            ...
            menu = new Menu("【超神汉化】"+ Player.ChampionName, Player.ChampionName, true);

            //Info
            menu.AddSubMenu(new Menu("超神汉化", "Info"));
            menu.SubMenu("Info").AddItem(new MenuItem("Author", "作者：xSalice"));
            menu.SubMenu("Info").AddItem(new MenuItem("Paypal", "捐赠作者: xSalicez@gmail.com"));
			menu.SubMenu("Info").AddItem(new MenuItem("QQ", "L#汉化群：386289593"));
            //Target selector
