...
namespace xSaliceReligionAIO
{
    class Champion
    {
        ...
        {
            Game.PrintChat("<font color = \"#FFB6C1\">銆愯秴绁炴眽鍖栥€憍Salice瀹楁暀绯诲垪</font> 浣滆€咃副 <font color = \"#00FFFF\">xSalice</font>");
            Game.PrintChat("<font color = \"#87CEEB\">浣犺寰楀ソ鐢ㄨ鎹愯禒PayPal璐﹀彿:</font> <font color = \"#FFFF00\">xSalicez@gmail.com</font>");

            menu = new Menu("【超神汉化】宗教系列-" + Player.ChampionName, Player.ChampionName, true);
			...
			menu.SubMenu("Info").AddItem(new MenuItem("lingdu", "零度汉化群:386289593"));
            ...
            //Orbwalker submenu
            OrbwalkerMenu.AddItem(new MenuItem("Orbwalker_Mode", "走砍模式", true).SetValue(false));
        ...
        {
            myMenu.AddItem(new MenuItem(source + "_Manamanager", "最低蓝量", true).SetValue(new Slider(standard)));
        }
