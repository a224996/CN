    ...
    class Veigar : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("热键", "Keys");
            {
                ...
                key.AddItem(new MenuItem("LastHitQQ", "Q 补兵", true).SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
                key.AddItem(new MenuItem("LastHitQQ2", "Q 补兵(锁定)", true).SetValue(new KeyBind("J".ToCharArray()[0], KeyBindType.Toggle)));
                key.AddItem(new MenuItem("wPoke", "投掷 W 眩晕", true).SetValue(new KeyBind("N".ToCharArray()[0], KeyBindType.Toggle)));
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("waitW", "等待W再E", true).SetValue(true));
                combo.AddItem(new MenuItem("castWonTopOfE", "投掷W后立即E", true).SetValue(false));
                combo.AddItem(new MenuItem("UseRCombo", "使用 R", true).SetValue(true));
                combo.AddItem(new MenuItem("DFGMode", "冥火模式", true).SetValue(new StringList(new[] {"连招", "冥火-R"})));
            ...
            var misc = new Menu("杂项", "Misc"); { 
                ...
                misc.AddItem(new MenuItem("UseGap", "使用 W 防止突进", true).SetValue(true));
                misc.AddItem(new MenuItem("overKill", "击杀检查", true).SetValue(true));
                misc.AddItem(new MenuItem("smartKS", "使用智能击杀系统", true).SetValue(true));

                misc.AddSubMenu(new Menu("不使用 R", "DontUlt"));
                ...
                misc.AddSubMenu(new Menu("不使用冥火", "DontDFG"));
            ...
            var drawing = new Menu("绘制", "Drawings"); { 
               ...
               drawing.AddItem(new MenuItem("manaStatus", "法力状态", true).SetValue(true));
