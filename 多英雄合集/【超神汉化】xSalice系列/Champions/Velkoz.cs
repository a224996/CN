    ...
    class Velkoz : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("热键", "Key");
            {
                ...
                key.AddItem(new MenuItem("R_Mouse", "R鼠标位置",true).SetValue(new KeyBind("R".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var spell = new Menu("技能", "Spell");
            {
                ...
                var qMenu = new Menu("Q", "QSpell"); {
                    qMenu.AddItem(new MenuItem("qSplit", "自动分叉Q",true).SetValue(true));
                    qMenu.AddItem(new MenuItem("qAngle", "在角落Q",true).SetValue(true));
                    spell.AddSubMenu(qMenu);
                }   
                //R
                var rMenu = new Menu("R", "RSpell");
                {
                    rMenu.AddItem(new MenuItem("rAimer", "R瞄准",true).SetValue(new StringList(new[] { "自动", "鼠标位置" })));
            ...
            var harass = new Menu("骚扰", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("qHit2", "Q击中几率",true).SetValue(new Slider(3, 1, 4)));
            ...
            var farm = new Menu("清线", "Farm");
            {
                ...
                farm.AddItem(new MenuItem("UseEFarm", "使用E",true).SetValue(false));
            ...
            var draw = new Menu("显示", "Drawings"); { 
                ...
                draw.AddItem(new MenuItem("drawUlt", "R可杀",true).SetValue(true));
