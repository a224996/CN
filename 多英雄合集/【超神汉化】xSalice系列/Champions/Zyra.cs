    ...
    class Zyra : Champion
    {
        ...
        private void LoadMenu()
        {
            ...
            var key = new Menu("热键", "Key");
            {
                ...
                key.AddItem(new MenuItem("Escape", "E 逃跑", true).SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
                //add to menu
                menu.AddSubMenu(key);
            }
            ...
            var combo = new Menu("连招", "Combo");
            {
                ...
                combo.AddItem(new MenuItem("qHit", "Q/E 命中几率", true).SetValue(new Slider(3, 1, 4)));
                ...
                combo.AddItem(new MenuItem("R_Min", "如果R > =敌人，6 =关闭", true).SetValue(new Slider(3, 1, 6)));
                //add to menu
            ...
            var harass = new Menu("骚扰", "Harass");
            {
                ...
                harass.AddItem(new MenuItem("qHit2", "Q/E 命中几率", true).SetValue(new Slider(3, 1, 4)));
            ...
            {
                misc.AddItem(new MenuItem("E_GapCloser", "使用 E 打断技能", true).SetValue(true));
                misc.AddItem(new MenuItem("smartKS", "智能击杀", true).SetValue(true));
                misc.AddItem(new MenuItem("Auto_Bloom", "如果敌人靠近自动激活植物", true).SetValue(true));
                //add to menu
            ...
            var drawing = new Menu("绘制", "Drawings");
            {
                ...
                drawing.AddItem(new MenuItem("Draw_R", "绘制 R", true).SetValue(true));
