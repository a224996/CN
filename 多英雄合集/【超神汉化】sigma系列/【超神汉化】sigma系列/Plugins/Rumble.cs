...
namespace SigmaSeries.Plugins
{
    public class Rumble : PluginBase
    {
        ...
        public override void ComboMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("castR", "手动R").SetValue(new KeyBind("R".ToCharArray()[0], KeyBindType.Press)));
        }
        ...
        public override void FarmMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("useEFarm", "E").SetValue(new StringList(new[] { "控线", "清线", "全部", "不" }, 0)));
        ...
        public override void BonusMenu(Menu config)
        {
            ...
            config.AddItem(new MenuItem("keepHeat", "保持热度").SetValue(new KeyBind("M".ToCharArray()[0], KeyBindType.Toggle)));
            config.AddItem(new MenuItem("keepHeatQ", "使用Q").SetValue(false));
            config.AddItem(new MenuItem("keepHeatW", "使用W").SetValue(true));
            config.AddItem(new MenuItem("KSE", "E抢头").SetValue(true));
        }
