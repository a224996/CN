...
namespace MalzaharSpaceAids
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            menu = new Menu("【無爲汉化】虚空先知", ChampionName, true);
            ...
            menu.SubMenu("Keys")
                .AddItem(
                    new MenuItem("lastHit", "Q 补兵").SetValue(
            ...
            menu.SubMenu("Combo").AddItem(new MenuItem("selected", "重点选择的目标").SetValue(true));
            ...
            menu.SubMenu("Misc").AddItem(new MenuItem("UseInt", "使用 Q/R 打断技能").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("UseGap", "使用 R 防突进").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("packet", "使用封包").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("smartKS", "使用智能击杀系统").SetValue(true));
            ...
            //Drawings menu:
            menu.AddSubMenu(new Menu("绘制", "Drawings"));
