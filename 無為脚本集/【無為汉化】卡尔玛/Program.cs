...
namespace Karma
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _config = new Menu("【無為汉化】卡尔玛", ChampionName, true);
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("UseEDefense", "使用 E 防御").SetValue(true));
            ...
            _config.SubMenu("Drawings")
                .AddItem(new MenuItem("WRootRange", "W 根范围").SetValue(new Circle(true, Color.MintCream)));
			...
			_config.AddSubMenu(new Menu("無為汉化", "by wuwei"));
