    ...
    internal class Program
    {
        ...
        private static void SmartW()
        {
            ...
            foreach (var existingSlide in ExistingSlide)
            {
                ...
                Game.PrintChat("鏁屼汉鏁伴噺: " + onSlidePositionEnemyCount);
                Game.PrintChat("瀵硅薄绠＄悊.鐜╁浣嶇疆 鏁屼汉鏁伴噺: " + onPlayerPositionEnemyCount);

                Game.PrintChat("W 浣嶇疆 : " + existingSlide.Position);
                Game.PrintChat("鐩爣浣嶇疆 : " + vTarget.Position);
            }
        }
