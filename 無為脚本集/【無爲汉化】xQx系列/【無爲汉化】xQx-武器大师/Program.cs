    ...
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.SubMenu("Combo")
                .AddItem(new MenuItem("UseQComboDontUnderTurret", "禁用塔下 Q").SetValue(true));
            Config.SubMenu("Combo")
            ...
            Config.SubMenu("Harass")
                .AddItem(new MenuItem("UseQHarassDontUnderTurret", "禁用塔下 Q").SetValue(true));
            Config.SubMenu("Harass").AddItem(new MenuItem("UseEHarass", "使用 E").SetValue(true));
            Config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("HarassMode", "骚扰模式: ").SetValue(
            ...
            Config.SubMenu("LaneClear")
                .AddItem(new MenuItem("UseQLaneClearDontUnderTurret", "禁用塔下 Q").SetValue(true));
            ...
            MenuTargetedItems.AddItem(new MenuItem("item3144", "兰盾").SetValue(true));
            ...
            MenuNonTargetedItems.AddItem(new MenuItem("item3143", "神圣之剑").SetValue(true));
            ...
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("DrawQMinRange", "最小 Q 范围").SetValue(
                        new Circle(true, System.Drawing.Color.GreenYellow)));
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("DrawWard", "顺眼范围").SetValue(
