...
namespace BlackPoppy
{
    internal class Program
    {
        ...
        {
            Menu = new Menu("【無爲汉化】Black-波比", "black" + ChampName, true);
            ...
            combo.AddItem(new MenuItem("comboLogicR", "敌人在范围内使用大招").SetValue(new Slider(2, 1, 5)));
            ...
            misc.AddItem(new MenuItem("miscUseW", "用W跟随鼠标").SetValue(true));
            misc.AddItem(new MenuItem("DontUlt", "不使用大招"));
