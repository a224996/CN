...
namespace BlackZilean
{
    internal class Program
    {
        ...
        {
            Menu = new Menu("【無爲汉化】Black-时光守护者", "black" + ChampName, true);
            ...
            Menu.AddSubMenu(ult);
            ult.AddItem(new MenuItem("ultUseR", "使用 R 给")).SetValue(true);
            ...
            ult.AddItem(new MenuItem("ultPercent", "R 血量 %")).SetValue(new Slider(25, 1));
            ...
            misc.AddItem(
                new MenuItem("miscEscapeToMouse", "跟随鼠标逃跑").SetValue(new KeyBind('G', KeyBindType.Press)));
            misc.AddItem(new MenuItem("miscUseE", "使用 E 跟随鼠标逃跑").SetValue(true));
