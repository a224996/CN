...
namespace Xerath_edit
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("【無為汉化】泽拉斯", ChampionName + "editedbyxcsoft", true);
            ...
            Config.SubMenu("R").AddItem(new MenuItem("rMode", "模式").SetValue(new StringList(new[] { "正常", "自定义", "点射"})));
            Config.SubMenu("R").AddItem(new MenuItem("rModeKey", "点射").SetValue(new KeyBind("T".ToCharArray()[0], KeyBindType.Press)));
            ...
            Config.SubMenu("R").AddItem(new MenuItem("BlockMovement", "右键点击暂停投掷R").SetValue(false));
            Config.SubMenu("R").AddItem(new MenuItem("OnlyNearMouse", "只关注鼠标附近的敌人").SetValue(false));
