...
namespace Sivir
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("【無為汉化】O-战争女神", ChampionName, true);
            ...
            #region Shield
                ...
                Config.SubMenu("E Shield Config").AddItem(new MenuItem("AGC", "防突进 E").SetValue(true));
                Config.SubMenu("E Shield Config").AddItem(new MenuItem("Edmg", "E 伤害 % 血量").SetValue(new Slider(0, 100, 0))); 
            #endregion
