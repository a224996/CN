...
namespace Annie
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("【無為汉化】O-安妮", ChampionName, true);
            ...
            Config.AddItem(new MenuItem("autoE", "自动 E 叠晕").SetValue(true));
            Config.AddItem(new MenuItem("farmQ", "补兵 Q").SetValue(true));
            Config.AddItem(new MenuItem("sup", "支持模式").SetValue(true));
            Config.AddItem(new MenuItem("rCount", "自动 R 敌人数>").SetValue(new Slider(3, 0, 5)));
