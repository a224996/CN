...
namespace Vayne_OneKeyToWin
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("【無為汉化】O-薇恩", ChampionName, true);
            ...
            Config.AddItem(new MenuItem("pots", "使用药品").SetValue(true));
            Config.AddItem(new MenuItem("opsE", "按流程使用W").SetValue(true));
            Config.AddItem(new MenuItem("AGC", "防突进").SetValue(true));
            Config.AddItem(new MenuItem("useE", "半手动 E ").SetValue(new KeyBind('t', KeyBindType.Press)));
