...
namespace D_Graves
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Graves
            _config = new Menu("【無為汉化】D-男枪", "D-Graves", true);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("diveintower", "塔下用E逃离")).SetValue(true);
            ...
            _config.SubMenu("R Factions").AddSubMenu(new Menu("连招使用 R", "Use R combo"));
            ...
            _config.SubMenu("R Factions").AddSubMenu(new Menu("使用R抢人头", "Use R killsteal"));
            _config.SubMenu("R Factions")
            ...
            _config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("harasstoggle", "自动骚扰 (切换)").SetValue(new KeyBind("G".ToCharArray()[0],
                        KeyBindType.Toggle)));
            _config.SubMenu("Harass")
                .AddItem(new MenuItem("Harrasmana", "最小蓝量").SetValue(new Slider(60, 1, 100)));
            _config.SubMenu("Harass")
                .AddItem(
            ...
            _config.SubMenu("Farm").AddItem(new MenuItem("UseQLH", "Q 补兵")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("UseWLH", "W 补兵")).SetValue(true);
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("Gap_E", "W 防突进")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("skinG", "使用自定义皮肤").SetValue(true));
            _config.SubMenu("Misc").AddItem(new MenuItem("skinGraves", "改变皮肤").SetValue(new Slider(4, 1, 6)));
            ...
            _config.SubMenu("HitChance")
                .SubMenu("Combo")
                .AddItem(
                    new MenuItem("Qchange", "Q 击中").SetValue(
                        new StringList(new[] {"低", "中等", "高", "非常高"})));
            _config.SubMenu("HitChance")
                .SubMenu("Combo")
                .AddItem(
                    new MenuItem("Wchange", "W 击中").SetValue(
                        new StringList(new[] {"低", "中等", "高", "非常高"})));
            _config.SubMenu("HitChance")
                .SubMenu("Combo")
                .AddItem(
                    new MenuItem("Rchange", "R 击中").SetValue(
                        new StringList(new[] {"低", "中等", "高", "非常高"})));
            _config.SubMenu("HitChance").AddSubMenu(new Menu("Harass", "Harass"));
            _config.SubMenu("HitChance")
                .SubMenu("Harass")
                .AddItem(
                    new MenuItem("Qchangeharass", "Q 击中").SetValue(
                        new StringList(new[] {"低", "中等", "高", "非常高"})));
            _config.SubMenu("HitChance")
                .SubMenu("Harass")
                .AddItem(
                    new MenuItem("Wchangeharass", "W 击中").SetValue(
                        new StringList(new[] {"低", "中等", "高", "非常高"})));
            _config.SubMenu("HitChance").AddSubMenu(new Menu("KillSteal", "KillSteal"));
            _config.SubMenu("HitChance")
                .SubMenu("KillSteal")
                .AddItem(
                    new MenuItem("Qchangekill", "Q 击中").SetValue(
                        new StringList(new[] {"低", "中等", "高", "非常高"})));
            _config.SubMenu("HitChance")
                .SubMenu("KillSteal")
                .AddItem(
                    new MenuItem("Wchangekill", "W 击中").SetValue(
                        new StringList(new[] {"低", "中等", "高", "非常高"})));
            _config.SubMenu("HitChance")
                .SubMenu("KillSteal")
                .AddItem(
                    new MenuItem("Rchangekill", "R 击中").SetValue(
                        new StringList(new[] {"低", "中等", "高", "非常高"})));
            ...
            Game.PrintChat("<font color='#881df2'>D-鐢锋灙 By Diabaths</font> 鍔犺浇鎴愬姛.");
            Game.PrintChat(
