...
namespace D_Nidalee
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Nidalee
            Config = new Menu("【無為汉化】D-豹女", "D-Nidalee", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseQComboCougar", "使用 Q 美洲豹")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("UseWComboCougar", "使用 W 美洲豹")).SetValue(true);
            Config.SubMenu("Combo").AddItem(new MenuItem("UseEComboCougar", "使用 E 美洲豹")).SetValue(true);
            Config.SubMenu("Combo")
                .AddItem(
                    new MenuItem("QHitCombo", "Q 命中率").SetValue(
                        new StringList(new[] {"低", "正常", "高", "很高"})));
            ...
            Config.SubMenu("Heal").AddItem(new MenuItem("UseAutoE", "使用自动 E")).SetValue(true);
            Config.SubMenu("Heal").AddItem(new MenuItem("HPercent", "血量%")).SetValue(new Slider(40, 1, 100));
            Config.SubMenu("Heal").AddItem(new MenuItem("AllyUseAutoE", "为队友自动 E")).SetValue(true);
            Config.SubMenu("Heal")
                .AddItem(new MenuItem("AllyHPercent", "血量%"))
                .SetValue(new Slider(40, 1, 100));

            Config.AddSubMenu(new Menu("物品", "items"));
            Config.SubMenu("items").AddSubMenu(new Menu("进攻", "Offensive"));
            Config.SubMenu("items")
                .SubMenu("Offensive")
                .AddItem(new MenuItem("UseItemsignite", "使用点燃"))
                .SetValue(true);
            Config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Tiamat", "使用提亚马特")).SetValue(true);
            Config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Hydra", "使用九头蛇")).SetValue(true);
            Config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Bilge", "使用弯刀")).SetValue(true);
            Config.SubMenu("items")
                .SubMenu("Offensive")
            ...
            Config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Blade", "使用弯刀")).SetValue(true);
            Config.SubMenu("items")
                .SubMenu("Offensive")
            ...
            Config.SubMenu("items").AddSubMenu(new Menu("防御", "Deffensive"));
            Config.SubMenu("items")
                .SubMenu("Deffensive")
                .AddItem(new MenuItem("Omen", "使用 Randuin Omen"))
                .SetValue(true);
            Config.SubMenu("items")
                .SubMenu("Deffensive")
            ...
            Config.SubMenu("items")
                .SubMenu("Deffensive")
                .AddItem(new MenuItem("lotis", "使用 Iron Solari"))
                .SetValue(true);
            Config.SubMenu("items")
                .SubMenu("Deffensive")
            ...
            Config.SubMenu("items")
                .SubMenu("Deffensive")
                .AddItem(new MenuItem("Zhonyas", "使用 Zhonya's"))
                .SetValue(true);
            Config.SubMenu("items")
                .SubMenu("Deffensive")
                .AddItem(new MenuItem("Zhonyashp", "使用 Zhonya's if HP%<").SetValue(new Slider(20, 1, 100)));
            Config.SubMenu("items").AddSubMenu(new Menu("Potions", "Potions"));
            Config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usehppotions", "使用 Healt potion/Flask/Biscuit"))
                .SetValue(true);
            Config.SubMenu("items")
                .SubMenu("Potions")
            ...
            Config.SubMenu("items")
                .SubMenu("Potions")
                .AddItem(new MenuItem("usemppotions", "使用 Mana potion/Flask/Biscuit"))
                .SetValue(true);
            Config.SubMenu("items")
                .SubMenu("Potions")
            ...
            Config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("harasstoggle", "自动骚扰 (切换)").SetValue(new KeyBind("G".ToCharArray()[0],
                        KeyBindType.Toggle)));
            Config.SubMenu("Harass")
                .AddItem(new MenuItem("Harrasmana", "蓝量").SetValue(new Slider(60, 1, 100)));
            Config.SubMenu("Harass")
                .AddItem(
            ...
            Config.SubMenu("Farm").AddSubMenu(new Menu("补兵", "LastHit"));
            Config.SubMenu("Farm").SubMenu("LastHit").AddItem(new MenuItem("UseQLH", "使用 Q (人形态)")).SetValue(true);
            Config.SubMenu("Farm")
                .SubMenu("LastHit")
                .AddItem(new MenuItem("lastmana", "蓝量% >").SetValue(new Slider(35, 1, 100)));
            Config.SubMenu("Farm")
                .SubMenu("LastHit")
                .AddItem(
                    new MenuItem("ActiveLast", "补兵!").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));

            Config.SubMenu("Farm").AddSubMenu(new Menu("清兵/野", "Lane"));
            Config.SubMenu("Farm").SubMenu("Lane").AddItem(new MenuItem("farm_E1", "使用 E (人形态)")).SetValue(true);
            Config.SubMenu("Farm").SubMenu("Lane").AddItem(new MenuItem("UseQLane", "使用 Q (美洲豹)")).SetValue(true);
            Config.SubMenu("Farm").SubMenu("Lane").AddItem(new MenuItem("UseWLane", "使用 W (美洲豹)")).SetValue(true);
            Config.SubMenu("Farm").SubMenu("Lane").AddItem(new MenuItem("UseELane", "使用 E (美洲豹)")).SetValue(true);
            Config.SubMenu("Farm")
                .SubMenu("Lane")
                .AddItem(
                    new MenuItem("LaneClear", "热键").SetValue(new KeyBind("V".ToCharArray()[0], KeyBindType.Press)));
            Config.SubMenu("Farm")
                .SubMenu("Lane")
                .AddItem(
                    new MenuItem("farm_R", "自动切换形态（锁定）").SetValue(new KeyBind("G".ToCharArray()[0],
                        KeyBindType.Toggle)));
            Config.SubMenu("Farm")
                .SubMenu("Lane")
                .AddItem(new MenuItem("Lane", "蓝量").SetValue(new Slider(60, 1, 100)));


            //Kill Steal
            Config.AddSubMenu(new Menu("杂项", "Misc"));
            Config.SubMenu("Misc").AddItem(new MenuItem("ActiveKs", "使用抢人头")).SetValue(true);
            Config.SubMenu("Misc").AddItem(new MenuItem("UseQKs", "使用 Q")).SetValue(true);
            Config.SubMenu("Misc").AddItem(new MenuItem("UseIgnite", "使用点燃")).SetValue(true);
            Config.SubMenu("Misc")
                .AddItem(new MenuItem("escapeterino", "逃跑!!!"))
                .SetValue(new KeyBind("z".ToCharArray()[0], KeyBindType.Press));

            //Damage after combo:
            MenuItem dmgAfterComboItem = new MenuItem("DamageAfterCombo", "显示连招伤害").SetValue(true);
            ...
            Config.SubMenu("Drawings").AddItem(new MenuItem("CircleLag", "简单线圈").SetValue(true));
