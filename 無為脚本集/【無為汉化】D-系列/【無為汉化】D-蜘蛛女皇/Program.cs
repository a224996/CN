    ...
    class Program
    {
       ...
       private static readonly int[] SmiteBlue = { 3706, 3710, 3709, 3708, 3707 };
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _config = new Menu("【無為汉化】D-蜘蛛女皇", "D-Elise", true);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("UseHumanQ", "人形态 Q")).SetValue(true);
            _config.SubMenu("Combo").AddItem(new MenuItem("UseHumanW", "人形态 W")).SetValue(true);
            _config.SubMenu("Combo").AddItem(new MenuItem("UseHumanE", "人形态 E")).SetValue(true);
            _config.SubMenu("Combo").AddItem(new MenuItem("UseRCombo", "自动使用 R")).SetValue(true);
            _config.SubMenu("Combo").AddItem(new MenuItem("UseSpiderQ", "蜘蛛形态 Q")).SetValue(true);
            _config.SubMenu("Combo").AddItem(new MenuItem("UseSpiderW", "蜘蛛形态 W")).SetValue(true);
            _config.SubMenu("Combo").AddItem(new MenuItem("UseSpiderE", "蜘蛛形态 E")).SetValue(true);
            _config.SubMenu("Combo")
                .AddItem(new MenuItem("ActiveCombo", "连招!").SetValue(new KeyBind(32, KeyBindType.Press)));

            //Harass
            _config.AddSubMenu(new Menu("骚扰", "Harass"));
            _config.SubMenu("Harass").AddItem(new MenuItem("UseQHarass", "骚扰 Q")).SetValue(true);
            _config.SubMenu("Harass").AddItem(new MenuItem("UseWHarass", "骚扰 W")).SetValue(true);
            _config.SubMenu("Harass")
                .AddItem(new MenuItem("Harrasmana", "最低蓝量").SetValue(new Slider(60, 1, 100)));
            _config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("ActiveHarass", "骚扰按键").SetValue(new KeyBind("C".ToCharArray()[0],
                        KeyBindType.Press)));
            ...
            _config.SubMenu("items")
                .SubMenu("Deffensive")
                .AddItem(new MenuItem("Zhonyashp", "使用中亚血量低于%<").SetValue(new Slider(20, 1, 100)));
            ...
            //Farm
            _config.AddSubMenu(new Menu("清兵", "Farm"));
            _config.SubMenu("Farm").AddItem(new MenuItem("HumanQFarm", "人形态 Q")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("HumanWFarm", "人形态 W")).SetValue(true);
            _config.SubMenu("Farm").AddItem(new MenuItem("SpiderQFarm", "蜘蛛形态 Q")).SetValue(false);
            _config.SubMenu("Farm").AddItem(new MenuItem("SpiderWFarm", "蜘蛛形态 W")).SetValue(true);
            _config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("Farm_R", "自动开关(切换)").SetValue(new KeyBind("G".ToCharArray()[0],
                        KeyBindType.Toggle)));
            _config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("ActiveFreeze", "补兵").SetValue(new KeyBind("X".ToCharArray()[0],
                        KeyBindType.Press)));
            _config.SubMenu("Farm")
                .AddItem(
                    new MenuItem("ClearActive", "清兵").SetValue(new KeyBind("V".ToCharArray()[0],
                        KeyBindType.Press)));
            _config.SubMenu("Farm").AddItem(new MenuItem("Lanemana", "最低蓝量").SetValue(new Slider(60, 1, 100)));

            //Farm
            _config.AddSubMenu(new Menu("清野", "Jungle"));
            _config.SubMenu("Jungle").AddItem(new MenuItem("HumanQFarmJ", "人形态 Q")).SetValue(true);
            _config.SubMenu("Jungle").AddItem(new MenuItem("HumanWFarmJ", "人形态 W")).SetValue(true);
            _config.SubMenu("Jungle").AddItem(new MenuItem("SpiderQFarmJ", "蜘蛛形态 Q")).SetValue(false);
            _config.SubMenu("Jungle").AddItem(new MenuItem("SpiderWFarmJ", "蜘蛛形态 W")).SetValue(true);
            ...
            _config.SubMenu("Smite").AddItem(new MenuItem("manaJ", "血量低于% <").SetValue(new Slider(35, 1, 100)));
            ...
            _config.SubMenu("Smite").AddItem(new MenuItem("smitecombo", "使用惩戒目标")).SetValue(true);
            _config.Item("smitecombo").ValueChanged += Switchcombo;
            _config.SubMenu("Smite").AddItem(new MenuItem("Smiteeee", "使用人形态E").SetValue(false));
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("Spidergapcloser", "蜘蛛形态E防突进")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("Humangapcloser", "人形态E防突进")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("UseEInt", "人形态E打断")).SetValue(true);
            _config.SubMenu("Misc")
                .AddItem(
                    new MenuItem("autoE", "高几率人形态E").SetValue(new KeyBind("T".ToCharArray()[0],
                        KeyBindType.Press)));
            _config.SubMenu("Misc")
                .AddItem(new MenuItem("Echange", "E命中率").SetValue(
            ...
            _config.SubMenu("Ks").AddItem(new MenuItem("HumanQKs", "人形态 Q")).SetValue(true);
            _config.SubMenu("Ks").AddItem(new MenuItem("HumanWKs", "人形态 W")).SetValue(true);
            _config.SubMenu("Ks").AddItem(new MenuItem("SpiderQKs", "蜘蛛形态 Q")).SetValue(true);
            ...
            _config.SubMenu("Drawings").AddItem(new MenuItem("SpiderDrawQ", "蜘蛛形态 Q")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("SpiderDrawE", "蜘蛛形态 E")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("Drawsmite", "显示惩戒")).SetValue(true);
            _config.SubMenu("Drawings").AddItem(new MenuItem("drawmode", "显示惩戒模式")).SetValue(true);
            ...
            Game.PrintChat("<font color='#881df2'>D-铚樿洓濂崇殗 by Diabaths</font> 鍔犺浇鎴愬姛.");
            Game.PrintChat(
