...
namespace D_Warwick
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Warwick
            _config = new Menu("【無為汉化】D-狼人", "D-Warwick", true);
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("myass", "使用 Q 如果敌人在Q范围")).SetValue(true);
            _config.SubMenu("Combo").AddItem(new MenuItem("savemyass", "使用 Q 血量% <").SetValue(new Slider(35, 1, 100)));
            _config.SubMenu("Combo").AddItem(new MenuItem("useWC", "使用 W").SetValue(true));
            _config.SubMenu("Combo").AddSubMenu(new Menu("大招", "Ulti_Use"));
            ...
            _config.SubMenu("Harass").AddItem(new MenuItem("UseItemsharass", "使用物品").SetValue(true));
            ...
            _config.SubMenu("Harass")
                .AddItem(new MenuItem("harasstoggle", "自动骚扰 (切换)").SetValue(new KeyBind("G".ToCharArray()[0],
                    KeyBindType.Toggle)));
            _config.SubMenu("Harass")
                .AddItem(
            ...
            _config.SubMenu("Farm").SubMenu("LaneClear").AddItem(new MenuItem("UseItemslane", "使用物品").SetValue(true));
            ...
            _config.SubMenu("Farm").SubMenu("Jungle").AddItem(new MenuItem("UseItemsjungle", "使用物品").SetValue(true));
            ...
            _config.SubMenu("Smite")
                .AddItem(
                    new MenuItem("Usesmite", "自动惩戒（切换)").SetValue(new KeyBind("H".ToCharArray()[0],
                        KeyBindType.Toggle)));
            ...
            _config.SubMenu("Smite")
                .AddItem(new MenuItem("healthJ", "血量HP% <").SetValue(new Slider(35, 1, 100)));

            //Misc
            _config.AddSubMenu(new Menu("杂项", "Misc"));
            _config.SubMenu("Misc").AddItem(new MenuItem("Inter_R", "R打断技能")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("UseIgnitekill", "使用点燃抢人头")).SetValue(true);
            ...
            //Draw
            _config.AddSubMenu(new Menu("绘制", "Drawing"));
            _config.SubMenu("Drawing").AddItem(new MenuItem("DrawQ", "Q范围").SetValue(true));
            _config.SubMenu("Drawing").AddItem(new MenuItem("DrawW", "W范围").SetValue(true));
            _config.SubMenu("Drawing").AddItem(new MenuItem("DrawE", "E范围").SetValue(true));
            _config.SubMenu("Drawing").AddItem(new MenuItem("DrawR", "R范围").SetValue(true));
            _config.SubMenu("Drawing").AddItem(new MenuItem("Drawsmite", "惩戒范围")).SetValue(true);
            _config.SubMenu("Drawing").AddItem(new MenuItem("CircleLag", "简易线圈").SetValue(true));
            ...
            Game.PrintChat("<font color='#881df2'>D-鐙间汉 by Diabaths</font> 鍔犺浇鎴愬姛.");
