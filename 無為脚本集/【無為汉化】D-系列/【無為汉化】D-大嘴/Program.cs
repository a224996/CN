...
namespace D_Kogmaw
{
    public static class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Kogmaw
            _config = new Menu("【無為汉化】D-大嘴", "D-Kogmaw", true);
            ...
            if (Skins.Count > 0)
            {
                _config.AddSubMenu(new Menu("改变皮肤", "Skin Changer"));
                _config.SubMenu("Skin Changer")
                    .AddItem(new MenuItem("Skin_enabled", "英雄改变皮肤").SetValue(false));
                _config.SubMenu("Skin Changer")
                    .AddItem(new MenuItem("Skin_select", "改变").SetValue(new StringList(Skins.ToArray())));
            ...
            _config.SubMenu("Combo").AddItem(new MenuItem("UseIgnitecombo", "使用点燃(可击杀)")).SetValue(true);
            _config.SubMenu("Combo").AddItem(new MenuItem("RlimC", "R极限").SetValue(new Slider(3, 1, 5)));
            ...
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Bilge", "使用破败")).SetValue(true);
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("BilgeEnemyhp", "敌人血量 <").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Bilgemyhp", "你的血量 <").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Blade", "使用弯刀")).SetValue(true);
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("BladeEnemyhp", "敌人血量 <").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Blademyhp", "你的血量 <").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Hextech", "使用科技枪")).SetValue(true);
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("HextechEnemyhp", "敌人血量 <").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items").SubMenu("Offensive").AddItem(new MenuItem("Hextechmyhp", "你的血量 <").SetValue(new Slider(85, 1, 100)));
            ...
            _config.SubMenu("Harass").AddItem(new MenuItem("RlimH", "R极限").SetValue(new Slider(2, 1, 5)));
            _config.SubMenu("Harass")
                .AddItem(
                    new MenuItem("harasstoggle", "自动骚扰(锁定)").SetValue(new KeyBind("G".ToCharArray()[0],
                        KeyBindType.Toggle)));
            _config.SubMenu("Harass")
                .AddItem(new MenuItem("Harrasmana", "最低蓝量").SetValue(new Slider(65, 1, 100)));
            _config.SubMenu("Harass")
                .AddItem(
            ...
            _config.SubMenu("Farm")
                .SubMenu("Lasthit")
                .AddItem(new MenuItem("Lastmana", "最低蓝量").SetValue(new Slider(65, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("Lasthit")
                .AddItem(
                    new MenuItem("ActiveLast", "补兵热键").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
            ...
            _config.SubMenu("Farm")
                .SubMenu("Laneclear")
                .AddItem(new MenuItem("RlimL", "R 最大被动").SetValue(new Slider(1, 1, 5)));
            _config.SubMenu("Farm")
                .SubMenu("Laneclear")
                .AddItem(new MenuItem("Lanemana", "最低蓝量").SetValue(new Slider(65, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("Laneclear")
                .AddItem(
                    new MenuItem("ActiveLane", "清兵热键").SetValue(new KeyBind("V".ToCharArray()[0],
                        KeyBindType.Press)));
            ...
            _config.SubMenu("Farm")
                .SubMenu("Jungleclear")
                .AddItem(new MenuItem("RlimJ", "R 最大被动").SetValue(new Slider(2, 1, 5)));
            _config.SubMenu("Farm")
                .SubMenu("Jungleclear")
            ...
            _config.SubMenu("Farm")
                .SubMenu("Jungleclear")
                .AddItem(
                    new MenuItem("Activejungle", "清野热键").SetValue(new KeyBind("V".ToCharArray()[0],
                        KeyBindType.Press)));
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("Gap_E", "E 防突进")).SetValue(true);
            ...
            _config.SubMenu("Drawings").AddItem(new MenuItem("damagetest", "显示文本")).SetValue(true);
