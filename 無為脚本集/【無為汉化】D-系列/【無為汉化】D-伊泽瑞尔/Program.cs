...
namespace D_Ezreal
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Ezreal
            _config = new Menu("【無為汉化】D-伊泽瑞尔", "D-Ezreal", true);
            ...
            //Ulti Factions
            _config.AddSubMenu(new Menu("R 设置", "R Factions"));
            _config.SubMenu("R Factions").AddSubMenu(new Menu("连招使用 R", "使用 R combo"));
            _config.SubMenu("R Factions")
                .SubMenu("Use R combo")
                .AddItem(new MenuItem("UseRcombo", "连招使用 R"))
                .SetValue(true);
            _config.SubMenu("R Factions")
                .SubMenu("Use R combo")
                .AddItem(new MenuItem("UseRrush", "如果R加连招伤害>=目标血量"))
                .SetValue(true);
            _config.SubMenu("R Factions")
                .SubMenu("Use R combo")
                .AddItem(new MenuItem("UseRC", "如果R伤害>目标血量"))
                .SetValue(true);
            _config.SubMenu("R Factions")
                .SubMenu("Use R combo")
                .AddItem(new MenuItem("UseRE", "几个敌人自动使用R"))
                .SetValue(true);
            _config.SubMenu("R Factions")
                .SubMenu("Use R combo")
                .AddItem(new MenuItem("MinTargets", "几个敌人自动使用R").SetValue(new Slider(2, 1, 5)));
            _config.SubMenu("R Factions").SubMenu("Use R combo").AddItem(new MenuItem("", "对以下目标使用R"));
            ...
            _config.SubMenu("R Factions").AddSubMenu(new Menu("使用R抢人头", "使用 R killsteal"));
            _config.SubMenu("R Factions")
                .SubMenu("Use R killsteal")
                .AddItem(new MenuItem("UseRM", "使用R抢人头"))
                .SetValue(true);
            _config.SubMenu("R Factions").SubMenu("Use R killsteal").AddItem(new MenuItem("", "对以下目标使用R"));
            foreach (var enemy in ObjectManager.Get<Obj_AI_Hero>().Where(enemy => enemy.Team != _player.Team))
                _config.SubMenu("R Factions")
                    .SubMenu("Use R killsteal")
                    .AddItem(new MenuItem("castRkill" + enemy.BaseSkinName, enemy.BaseSkinName).SetValue(false));
            _config.SubMenu("R Factions")
                .AddItem(new MenuItem("Minrange", "最小R范围内使用").SetValue(new Slider(800, 0, 1500)));
            _config.SubMenu("R Factions")
                .AddItem(new MenuItem("Maxrange", "最大R范围内使用").SetValue(new Slider(3000, 1500, 5000)));
            ...
            _config.SubMenu("items")
                .SubMenu("Offensive")
                .AddItem(new MenuItem("usemuramana", "使用魔宗利刃"))
                .SetValue(true);
            _config.SubMenu("items")
                .SubMenu("Offensive")
                .AddItem(new MenuItem("muramanamin", "MP < %").SetValue(new Slider(25, 1, 100)));
            ...
            _config.SubMenu("items")
                .SubMenu("Offensive")
                .AddItem(new MenuItem("Bilgemyhp", "或者你的血量 < ").SetValue(new Slider(85, 1, 100)));
            ...
            _config.SubMenu("items")
                .SubMenu("Offensive")
                .AddItem(new MenuItem("Hextech", "海克斯科技枪刃"))
                .SetValue(true);
            _config.SubMenu("items")
                .SubMenu("Offensive")
                .AddItem(new MenuItem("HextechEnemyhp", "敌人血量低于 <").SetValue(new Slider(85, 1, 100)));
            _config.SubMenu("items")
                .SubMenu("Offensive")
                .AddItem(new MenuItem("Hextechmyhp", "或者你的血量低于 <").SetValue(new Slider(85, 1, 100)));
            ...
            _config.SubMenu("items").SubMenu("Deffensive").SubMenu("Cleanse").AddItem(new MenuItem("useqss", "使用净化 /水银弯刀/旋刃")).SetValue(true);
            ...
            _config.SubMenu("items").SubMenu("Deffensive").SubMenu("Cleanse").AddItem(new MenuItem("flee", "逃离")).SetValue(true);
            _config.SubMenu("items").SubMenu("Deffensive").SubMenu("Cleanse").AddItem(new MenuItem("snare", "夹子")).SetValue(true);
            ...
            _config.SubMenu("items").SubMenu("Deffensive").SubMenu("Cleanse").AddItem(new MenuItem("Cleansemode", "使用净化")).SetValue(new StringList(new string[2] { "Always", "In Combo" }));
            ...
            _config.SubMenu("Farm").AddSubMenu(new Menu("LaneClear", "清兵"));
            ...
            _config.SubMenu("Farm")
                .SubMenu("Lasthit")
                .AddItem(new MenuItem("lastmana", "最低蓝量").SetValue(new Slider(60, 1, 100)));
            _config.SubMenu("Farm")
                .SubMenu("Lasthit")
                .AddItem(
            ...
            _config.SubMenu("Misc")
                .AddItem(new MenuItem("pingulti", "如果R >敌人健康（本地Ping）").SetValue(false));
            _config.SubMenu("Misc").AddItem(new MenuItem("useQK", "使用 Q 抢人头")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("useWK", "使用 W 抢人头")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("useEK", "使用 (E-Q) 或 (E-W) 抢人头")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("useQdash", "自动 Q 突进的")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("useQimmo", "自动 Q 不动的")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("useQstun", "自动 Q 嘲讽/恐惧/魅惑/陷阱")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("EZAutoLevel", "自动加点")).SetValue(false);
            _config.SubMenu("Misc").AddItem(new MenuItem("EZStyle", "等级顺序").SetValue(
                new StringList(new[] {"W-E-Q", "W-Q-E", "Q-E-W", "Q-W-E"})));
            _config.SubMenu("Misc").AddItem(new MenuItem("skinez", "使用自定义皮肤").SetValue(false));
            _config.SubMenu("Misc").AddItem(new MenuItem("skinezreal", "自定义皮肤").SetValue(new Slider(4, 1, 8)));

            //Damage after combo:
            MenuItem dmgAfterComboItem = new MenuItem("DamageAfterCombo", "连招后的损伤").SetValue(true);
            ...
            _config.SubMenu("Drawings").AddItem(new MenuItem("damagetest", "损伤文本")).SetValue(true);
            ...
            Game.PrintChat("<font color='#881df2'>D-Ez by Diabaths</font> 鍔犺浇鎴愬姛.");
            Game.PrintChat(
