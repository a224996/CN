...
namespace Vi
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("【初见汉化】xQx蔚", "Vi", true);

            var targetSelectorMenu = new Menu("[初见汉化] - 目标选择器", "Target Selector");
            ...
            /* [ Don't Use Ult ] */
            Config.SubMenu("Combo").AddSubMenu(new Menu("不使用大招", "DontUlt"));
            ...
            Config.SubMenu("Combo").AddSubMenu(new Menu("团战", "FindHim"));
            Config.SubMenu("Combo")
                .SubMenu("FindHim")
                .AddItem(new MenuItem("ForceFocusctive", "Q充能").SetValue(false));
            ...
            Config.SubMenu("Combo")
                .AddItem(
                    new MenuItem("ComboFlashQActive", "连招 闪现+Q!").SetValue(
            ...
            harassUseQ.AddItem(new MenuItem("UseQHarassDontUnderTurret", "在塔下不使用Q").SetValue(true));
            Config.SubMenu("Harass").AddItem(new MenuItem("UseEHarass", "使用 E").SetValue(true));
            Config.SubMenu("Harass")
                .AddItem(new MenuItem("HarassMana", "法力值: ").SetValue(new Slider(50, 100, 0)));
            Config.SubMenu("Harass")
                .AddItem(
            ...
            // Lane Clear
            Config.AddSubMenu(new Menu("[初见汉化] - 清线", "LaneClear"));
            ...
            Config.SubMenu("LaneClear")
                .AddItem(new MenuItem("LaneClearMana", "Min.法力值: ").SetValue(new Slider(50, 100, 0)));
            Config.SubMenu("LaneClear")
                .AddItem(
            ...
            Config.SubMenu("JungleFarm")
                .AddItem(new MenuItem("JungleFarmMana", "法力值: ").SetValue(new Slider(50, 100, 0)));
            ...
            {
                menuRun.AddItem(
                    new MenuItem("FleeActive", "清野!").SetValue(new KeyBind("A".ToCharArray()[0], KeyBindType.Press)));
                Config.AddSubMenu(menuRun);
            }

            // Extras -> Use Items 
            MenuExtras = new Menu("[初见汉化] - 杂项", "Extras");
            Config.AddSubMenu(MenuExtras);
            MenuExtras.AddItem(new MenuItem("InterruptSpells", "打断").SetValue(true));

            Menu menuUseItems = new Menu("使用物品", "menuUseItems");
            Config.SubMenu("Extras").AddSubMenu(menuUseItems);
            // Extras -> Use Items -> Targeted Items
            MenuTargetedItems = new Menu("有针对性的物品", "menuTargetItems");
            menuUseItems.AddSubMenu(MenuTargetedItems);

            MenuTargetedItems.AddItem(new MenuItem("item3153", "破败王者之刃").SetValue(true));
            ...
            MenuNonTargetedItems.AddItem(new MenuItem("item3180", "奥戴恩的面纱").SetValue(true));
            ...
            // Drawing
            Config.AddSubMenu(new Menu("[初见汉化] - 技能范围", "Drawings"));
            ...
            Config.SubMenu("Drawings")
                .AddItem(
                    new MenuItem("FQRange", "闪现+Q 范围").SetValue(
