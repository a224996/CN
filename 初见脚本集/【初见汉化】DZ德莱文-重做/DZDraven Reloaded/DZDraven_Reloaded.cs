...
namespace DZDraven_Reloaded
{
    class DZDraven_Reloaded
    {
        ...
        public static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Menu.SubMenu("Misc").AddItem(new MenuItem("WCatchCombo", "只用于连招").SetValue(false));
            ...
            Menu.AddSubMenu(new Menu("[初见汉化] - 技能范围", "Drawing"));
