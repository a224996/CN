...
namespace FedCaitlyn
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            var targetSelectorMenu = new Menu("|初见汉化-目标选择|", "TargetSelector");
        ...
        {
            var vTarget = TargetSelector.GetTarget(E.Range - 30, TargetSelector.DamageType.Physical);
        ...
        private static void Killer()
        {
            ...
            var eTarget = TargetSelector.GetTarget(E.Range - 50, TargetSelector.DamageType.Physical);
        ...
        {
            var rTarget = TargetSelector.GetTarget(GetRRange() - 100, TargetSelector.DamageType.Physical);
        ...
        private static Obj_AI_Hero Cast_BasicLineSkillshot_Enemy(Spell spell, TargetSelector.DamageType damageType = TargetSelector.DamageType.Physical)
        {
            var QonlyAA = Config.Item("QMin").GetValue<bool>();
