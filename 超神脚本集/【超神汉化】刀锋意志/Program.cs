...
namespace ChewyMoonsIrelia
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Utilities.PrintChat("鍒濊姹夊寲 QQ藟5011477  鍔犺浇鎴愬姛.");
        }
        ...
        private static void FireCharges()
        {
            ...
            _r.Cast(TargetSelector.GetTarget(1000, TargetSelector.DamageType.Physical), _packetCast); //Dunnno
            _charges -= 1;
        ...
        {
            _menu = new Menu("【初见汉化】刀锋意志", "cmIrelia", true);

            // Target Selector
            var targetSelectorMenu = new Menu("[初见汉化] - 目标选择器", "cmIreliaTS");
            TargetSelector.AddToMenu(targetSelectorMenu);
            _menu.AddSubMenu(targetSelectorMenu);

            // Orbwalker
            var orbwalkerMenu = new Menu("[初见汉化] - 走砍", "cmIreliaOW");
            Orbwalker = new LXOrbwalker();
            LXOrbwalker.AddToMenu(orbwalkerMenu);
            _menu.AddSubMenu(orbwalkerMenu);

            // Combo
            var comboMenu = new Menu("[初见汉化] - 连招", "cmIreliaCombo");
            ...
            // Lasthiting
            var farmingMenu = new Menu("[初见汉化] - 清线/清野", "cmIreliaFarming");
            ...
            //Drawing menu
            var drawingMenu = new Menu("[初见汉化] - 技能范围", "cmIreliaDraw");
            ...
            //Misc
            var miscMenu = new Menu("[初见汉化] - 杂项", "cmIreliaMisc");
...
_menu.AddSubMenu(new Menu("初见汉化", "by chujian"));
            _menu.SubMenu("by chujian").AddItem(new MenuItem("qunhao", "汉化群：386289593"));
            _menu.SubMenu("by chujian").AddItem(new MenuItem("qunhao1", "交流群：333399"));
