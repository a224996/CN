...
namespace xWard
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            xMenu = new Menu("【超神汉化】眼位", "xWard", true);

            
            xMenu.AddSubMenu(new Menu("Ward", "Ward"));
            xMenu.SubMenu("Ward").AddItem(new MenuItem("Draww", "显示眼位").SetValue(true));
            xMenu.SubMenu("Ward").AddItem(new MenuItem("placew", "眼位").SetValue(new KeyBind('Z', KeyBindType.Press)));
