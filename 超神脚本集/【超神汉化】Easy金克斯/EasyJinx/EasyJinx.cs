...
namespace EasyJinx
{
    class EasyJinx : Champion
    {
        ...
        protected override void InitializeMenu()
        {
            ...
            Menu.SubMenu("Combo").AddItem(new MenuItem("Combo_e", "使用E").SetValue(true));
            ...
            Menu.SubMenu("Harass").AddItem(new MenuItem("Harass_e", "使用E").SetValue(false));

            Menu.AddSubMenu(new Menu("Auto", "Auto"));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_eslow", "对减速敌人使用E").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_estun", "对眩晕敌人使用E on stunned enemies").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_egap", "使用E防突").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_r", "使用R").SetValue(true));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_minrange", "最小R范围").SetValue(new Slider(1050, 0, 1500)));
            Menu.SubMenu("Auto").AddItem(new MenuItem("Auto_maxrange", "最大R范围").SetValue(new Slider(3000, 1500, 5000)));

            Menu.AddSubMenu(new Menu("显示", "Drawing"));
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_q", "Q范围").SetValue(new Circle(true, System.Drawing.Color.FromArgb(100, 0, 255, 0))));
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_w", "W范围").SetValue(new Circle(true, System.Drawing.Color.FromArgb(100, 0, 255, 0))));
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_e", "E范围").SetValue(new Circle(true, System.Drawing.Color.FromArgb(100, 0, 255, 0))));
            Menu.SubMenu("Drawing").AddItem(new MenuItem("Drawing_rdamage", "R伤害指示器").SetValue(true));

            Menu.AddSubMenu(new Menu("杂项", "Misc"));
            Menu.SubMenu("Misc").AddItem(new MenuItem("Misc_qswitch", "小兵切换机关枪").SetValue(true));
