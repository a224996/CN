...
namespace LissandraLetitGoLetItGOOOOO
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu.SubMenu("Keys").AddItem(new MenuItem("LaneClearActive", "补兵").SetValue(new KeyBind("Z".ToCharArray()[0], KeyBindType.Press)));
            ...
            menu.SubMenu("Drawings")
                .AddItem(new MenuItem("qExtend", "Q最大范围").SetValue(new Circle(false, Color.FromArgb(100, 255, 0, 255))));
            menu.SubMenu("Drawings")
