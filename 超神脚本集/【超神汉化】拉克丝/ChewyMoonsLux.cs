...
namespace ChewyMoonsLux
{
    internal class ChewyMoonsLux
    {
        ...
        public static void OnGameLoad(EventArgs args)
        {
            ...
            Game.OnUpdate += LuxCombo.OnGameUpdate;
        ...
        {
            Menu = new Menu("【初见汉化】拉克丝", "cmLux", true);

            // Target Selector
            var tsMenu = new Menu("[初见汉化] - 目标选择器", "cmLuxTs");
            TargetSelector.AddToMenu(tsMenu);
            Menu.AddSubMenu(tsMenu);

            // Orbwalker
            var orbwalkerMenu = new Menu("[初见汉化] - 走砍", "cmLuxOrbwalker");
            Orbwalker = new Orbwalking.Orbwalker(orbwalkerMenu);
            Menu.AddSubMenu(orbwalkerMenu);

            // Combo settings
            var comboMenu = new Menu("[初见汉化] - 连招", "cmLuxCombo");
            ...
            // Harass Settings
            var harassMenu = new Menu("[初见汉化] - 骚扰", "cmLuxHarass");
            ...
            var ksMenu = new Menu("[初见汉化] - 击杀选项", "cmLuxKS");
            ...
            // Items
            var itemsMenu = new Menu("[初见汉化] - 项目", "cmLuxItems");
            itemsMenu.AddItem(new MenuItem("useDFG", "使用冥火").SetValue(true));
            Menu.AddSubMenu(itemsMenu);

            //Drawing
            var drawingMenu = new Menu("[初见汉化] - 技能范围", "cmLuxDrawing");
            ...
            // Misc
            var miscMenu = new Menu("[初见汉化] - 杂项", "cmLuxMisc");
