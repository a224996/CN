...
namespace Cassiopeia
{
    class Program
    {
        ...
        static Menu menu = new Menu("【超神汉化】HT蛇女", "Cassiopeia", true);
        ...
        static void OnGameLoad(EventArgs args)
        {
            ...
            menu.SubMenu("Harass").AddItem(new MenuItem("qHarass", "使用Q").SetValue(true));
            menu.SubMenu("Harass").AddItem(new MenuItem("wHarass", "使用W").SetValue(false));
            menu.SubMenu("Harass").AddItem(new MenuItem("eHarass", "使用E").SetValue(true));

            menu.AddSubMenu(new Menu("清线", "LineClear"));
            menu.SubMenu("LineClear").AddItem(new MenuItem("lineclearQ", "使用Q").SetValue(true));
            menu.SubMenu("LineClear").AddItem(new MenuItem("lineclearW", "使用W").SetValue(false));
            menu.SubMenu("LineClear").AddItem(new MenuItem("onlylasthitE", "只有补兵用E").SetValue(true));

            menu.AddSubMenu(new Menu("清野", "JungleClear"));
            menu.SubMenu("JungleClear").AddItem(new MenuItem("jungleclearQ", "使用Q").SetValue(true));
            menu.SubMenu("JungleClear").AddItem(new MenuItem("jungleclearW", "使用W").SetValue(false));

            menu.AddSubMenu(new Menu("大招", "Ultimate"));
            menu.SubMenu("Ultimate").AddItem(new MenuItem("comboR", "使用大招").SetValue(true));

            menu.SubMenu("Ultimate").SubMenu("AntiGapcloser").AddItem(new MenuItem("gapcloserR", "对突进使用大招").SetValue(false));
            menu.SubMenu("Ultimate").SubMenu("Interruptspells").AddItem(new MenuItem("interruptR", "使用大招打断技能").SetValue(true));
            ...
            {
                menu.SubMenu("Ultimate").SubMenu("AntiGapcloser").AddItem(new MenuItem(enemyChamp.ChampionName + "gapcloser", "突进 " + enemyChamp.ChampionName).SetValue(true));
                menu.SubMenu("Ultimate").SubMenu("Interruptspells").AddItem(new MenuItem(enemyChamp.ChampionName + "interrupt", "打断技能 " + enemyChamp.ChampionName).SetValue(true));
                if (enemyChamp.ChampionName == "Yasuo")
                    yasuoHere = true;
            }

            menu.AddSubMenu(new Menu("杂项", "Misc"));
            menu.SubMenu("Misc").AddItem(new MenuItem("castedalay", "E最小延迟").SetValue(new Slider(0, 0, 2000)));
            menu.SubMenu("Misc").AddItem(new MenuItem("castedalay2", "E最大延迟").SetValue(new Slider(0, 0, 2000)));
            menu.SubMenu("Misc").AddItem(new MenuItem("castWPoisoned", "目标不中毒才用W").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("focusSelectedTarget", "锁定目标").SetValue(false));
            menu.SubMenu("Misc").AddItem(new MenuItem("useAAcombo", "连招使用平A").SetValue(true));
            menu.SubMenu("Misc").AddItem(new MenuItem("PacketCast", "使用封包").SetValue(true));

            menu.AddSubMenu(new Menu("显示", "Drawings"));
            menu.SubMenu("Drawings").AddItem(new MenuItem("QRange", "Q范围").SetValue(new Circle(false, Color.FromArgb(150, Color.DodgerBlue))));
            menu.SubMenu("Drawings").AddItem(new MenuItem("ERange", "E范围").SetValue(new Circle(false, Color.FromArgb(150, Color.DodgerBlue))));
            menu.SubMenu("Drawings").AddItem(new MenuItem("RRange", "R范围").SetValue(new Circle(false, Color.FromArgb(150, Color.DodgerBlue))));
            menu.SubMenu("Drawings").SubMenu("DrawHP").AddItem(new MenuItem("drawHPDmg", "显示血条的伤害").SetValue(true));
            menu.SubMenu("Drawings").SubMenu("DrawHP").AddItem(new MenuItem("qCountsDraw", "有Q的时候再计算").SetValue(new Slider(2, 1, 5)));
            menu.SubMenu("Drawings").SubMenu("DrawHP").AddItem(new MenuItem("eCountsDraw", "有E的时候再计算").SetValue(new Slider(4, 1, 10)));
            menu.SubMenu("Drawings").SubMenu("DrawHP").AddItem(new MenuItem("RCountsDraw", "有R的时候再计算").SetValue(true));
