...
namespace Primes_Ultimate_Carry
{
	class PUC
	{
		...
		public PUC()
		{
			...
			Game.PrintChat("<font color=\"#FFFF00\">銊у墤榄斻劎寰疯幈鏂囥劎浼婃辰鐟炲皵銊х撼灏斻劎閲戝厠鏂劎璺タ瀹夈劎鍙戞潯銊ч敜鐭炽劎</font>");
			Game.PrintChat("<font color=\"#FF0000\">鏇村姹夊寲鑴氭湰璇峰姞: L#姹夊寲缇わ細386289593</font>");
