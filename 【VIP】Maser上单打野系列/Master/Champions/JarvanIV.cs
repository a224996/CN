...
namespace Master
{
    class JarvanIV : Program
    {
        ...
        public JarvanIV()
        {
            ...
            Config.SubMenu("Orbwalker").SubMenu("xSLxOrbwalker_Modes").AddItem(new MenuItem("EQFlash", "连招闪现EQ").SetValue(new KeyBind("X".ToCharArray()[0], KeyBindType.Press)));
            ...
            Config.SubMenu("csettings").AddItem(new MenuItem("autowusage", "使用W If Hp Under").SetValue(new Slider(20, 1)));
            ...
            Config.SubMenu("csettings").AddItem(new MenuItem("ruseMode", "R模式").SetValue(new StringList(new[] { "击杀", "敌人大于" })));
            ...
            Config.SubMenu("hsettings").AddItem(new MenuItem("harMode", "血量大于X使用EQ").SetValue(new Slider(20, 1)));
            ...
            Config.SubMenu("miscs").AddItem(new MenuItem("killstealQ", "自动Q抢头").SetValue(true));
